...
const useConvertToResult = (data: IDataItem[]): ILayoutItem[] => {
  const result = [];
      ...
      if (data[indexDataStart]) {
        ...
        if (toRecord) {
          ...
          result.push({
            ...
            component: data[indexDataStart].component,
            padding: data[indexDataStart].padding,
          });
        }
      }
...
export default useConvertToResult;
